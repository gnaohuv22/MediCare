 ...
 * @author DELL
 */
@WebServlet(name="DeleteEmployee", urlPatterns={"/admin-delete-employee-controller"})
public class AdminDeleteEmployee extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        AdminGetEmployeeToEdit emp = (AdminGetEmployeeToEdit)session.getAttribute("EMPLOYEE");
        if (emp==null){
