...
public class AdminEditEmployeeProfile extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        GetEmployee currentEmp = (GetEmployee)session.getAttribute("EMPLOYEE");
        Employee emp = currentEmp.getEmployee();
        EmployeeDAO eDao = new EmployeeDAO();
        String id = currentEmp.getEmployee().getId();
        String email;
        String name;
        String password;
        String birthDate;
...
//        String createAt ="";
                ...
                Logger.getLogger(AdminEditEmployeeProfile.class.getName()).log(Level.SEVERE, null, ex);
            }
                }
                ...
                if (!newPassword.equals("")){
                    try{
                        ...
                        try{
                            ...
                            if (currentEmp.getEmployee().getPassword().equals(newPassword)) throw new AdminException.PasswordNotChange();
