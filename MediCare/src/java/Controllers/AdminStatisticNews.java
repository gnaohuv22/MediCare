 ...
 * @author DELL
 */
@WebServlet(name="StatisticNews", urlPatterns={"/admin-list-news"})
public class AdminStatisticNews extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<GetNews> list = eDao.getAllNews();
        ArrayList<String> titleList = vDao.getTitleTableNews();
