    ...
    <body>
                                                        ...
                                                        <c:if test="${appointment.getStatus().equals(status.link)}">
                                                            ...
                                                            <td class="text-center">
                                                                <!--<div class="dropdown dropdown-action">-->
                                                                    ...
                                                                    <a data-pending-appointment-id="${appointment.id}" data-doctor-name="${appointment.doctor.getDisplayName()}" class="dropdown-item edit-appointment-button" href="#" onclick="eventClickSolvePendingAppointments(this)"><i class="fa fa-pencil m-r-5"></i> Xem chi tiết</a>
        ...
        <div id="editAppointmentForm" class="form-popup">
            ...
            <form action="admin-update-schedule-doctor" class="form-container" method="post">
                ...
                <button type="button" id="schedule-close-button" onclick="closeSolvePendingAppointmentsForm()">Close</button>
            </form>
        </div>
        <!--Popup - End-->
        <script>
...
//                        document.getElementById("method").value = "add";
            ...
            function eventClickSolvePendingAppointments(event) {
                ...
                console.log("Event is click: " + event.getAttribute("data-canceled-appointment-id"));
                var modal = document.getElementById("editAppointmentForm");
                modal.style.display = "block";
//                document.getElementById("method").value = "add";
//                document.getElementById("schedule-submit-button").innerHTML = "Update";
...
//                        document.getElementById("method").value = "add";
                ...
                $.ajax({
                    url: "/MediCare/admin-manage-canceled-appointments",
                    data: {
